...
// 1. Função de renderização HTML da lista de projetos (usada pelo Widget e pelo Shortcode)
...
// 2. Shortcode fallback [andorinha_projetos posts="6" columns="3"]
...
// 3. Registrar Widget nativo do Elementor
function andorinha_register_elementor_projetos_widget() {
    ...
    \Elementor\Plugin::instance()->widgets_manager->register( new Andorinha_Projetos_Elementor_Widget() );
}
add_action( 'elementor/widgets/register', 'andorinha_register_elementor_projetos_widget' );
add_action( 'elementor/widgets/widgets_registered', 'andorinha_register_elementor_projetos_widget' );
